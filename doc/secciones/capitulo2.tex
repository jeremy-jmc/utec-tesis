...
\cite{Seed2025SeedCoder}, \cite{Ahmad2025OCRNVidia}, \cite{Hui2024Qwen25Coder}, \cite{Roziere2024CodeLlama}      % specialized for coding tasks


\cite{Grattafiori2024Llama3}        % recent latest models of medium size, trained for general capabilities, coding tasks and instruction following


\cite{Dominguez2024BlarSQL}     % models specialized for SQL tasks
\cite{Li2023BirdSQL}        % benchmark for SQL tasks
\cite{Lai2022DS1000}   % dataset for data science coding tasks
