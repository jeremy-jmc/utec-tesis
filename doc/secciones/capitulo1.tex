...
This section aims to introduce key definitions and theoretical foundations on spatio-temporal data, language models, and evaluation metrics, which are essential for understanding the development and scope of this work.
