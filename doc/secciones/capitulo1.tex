...
% Supervised fine-tuning is a process where a pre-trained language model is further trained on a labeled dataset specific to a task. This step refines the model's weights to improve performance on the desired application. For instance, in the context of crime data chatbots, fine-tuning can help the model better understand domain-specific terminology and generate more accurate responses.
...
\cite{Moshkov2025AIMO2}. \cite{Yin2024MuMathCode}, \cite{Li2024NuminaMath}
